...
class DirectoryListingTest extends TestCase
{
    ...
    public function mapping_a_listing(): void
    {
        ...
        $mappedListing = $listing->map(function (int $i) { return $i * 2; });
    ...
    public function mapping_a_listing_twice(): void
    {
        ...
        $mappedListing = $listing->map(function (int $i) { return $i * 2; });
        $mappedListing = $mappedListing->map(function (int $i) { return $i / 2; });
        $mappedNumbers = $mappedListing->toArray();
    ...
    public function filter_a_listing(): void
    {
        ...
        $fileredListing = $listing->filter(function (int $i) { return $i % 2 === 0; });
    ...
    public function filter_a_listing_twice(): void
    {
        ...
        $filteredListing = $listing->filter(function (int $i) { return $i % 2 === 0; });
        $filteredListing = $filteredListing->filter(function (int $i) { return $i > 10; });
