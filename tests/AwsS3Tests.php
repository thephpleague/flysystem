...
class AwsS3Tests extends PHPUnit_Framework_TestCase
{
    ...
    {
        return Mockery::mock('Aws\S3\Model\MultipartUpload\UploadBuilder[build,setSource,setBucket,setKey,setMinPartSize,setOption,setConcurrency,setSource]');
    }
